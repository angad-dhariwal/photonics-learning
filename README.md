...
Specifically, I use PyMeep, which is a library that allows MEEP to run with familiar python.
...
After working on the straight waveguide and the bent waveguide (viewable [here](/tutorials/media)
)
